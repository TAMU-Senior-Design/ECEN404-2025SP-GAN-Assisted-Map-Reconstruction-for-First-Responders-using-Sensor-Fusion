...
public class LoadPointCloud : MonoBehaviour
{
    ...
    void ProcessPointCloudJSON(string json)
    {
        ...
        // Iterate through the points and extract their coordinates and colors
        // Each point is expected to be an array of 6 elements: [x, y, z, r, g, b]
        ...
        // Offset the scan's position to be in front of the IMU to represent the physical distance from the sensor
        newLocalPos.z = -0.5f;
        scanObj.transform.localPosition = newLocalPos;

        // Add mesh components to the scan object
